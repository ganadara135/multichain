...
// var objOfme = {};    for "to"
// var arrOfme = [];    for "msg"    arrOfme[0] = {"for":"BookingStream","key":"bookingTime","data":"5554584f732046545721"};
//    {to: objOfme, msg : arrOfme}
        createRawSendFrom: ["from", {"to": ''},{"msg":[]},{"action":""}],
...
//    listStreams: [{"streams": "*"}, {"verbose": "false"}, {"count": undefined}, {"start": undefined}],
    listStreams: [{"streams": "*"}, {"verbose": false}, {"count": 10}, {"start": -10}],
